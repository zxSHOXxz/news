            ...
            <form >
             ...
             <div class="row">
                ...
                <div class="form-group col-md-4">
                  ...
                  value="{{ $admins->user->first_name }}" placeholder="Enter Firstname of Admin">
                </div>
                <div class="form-group col-md-4">
                  <label for="last_name">Last Name</label>
                  <input type="text" class="form-control" name="last_name" id="last_name"
                  value="{{ $admins->user->last_name }}" placeholder="Enter Lastname of Admin">
                </div>
              </div>
             ...
             <div class="row">
              ...
              <div class="form-group col-md-4">
                ...
                <div class="form-group col-md-4">
                  ...
                  value="{{ $admins->user->mobile }}" placeholder="Enter Firstname of Admin">
                </div>
               </div>
