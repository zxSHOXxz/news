            ...
            <form >
             ...
             <div class="row">
                ...
                <div class="form-group col-md-4">
                  ...
                  value="{{ $authors->user->first_name }}" placeholder="Enter Firstname of author">
                </div>
                <div class="form-group col-md-4">
                  <label for="last_name">Last Name</label>
                  <input type="text" class="form-control" name="last_name" id="last_name"
                  value="{{ $authors->user->last_name }}" placeholder="Enter Lastname of author">
                </div>
              </div>
             ...
             <div class="row">
              ...
              <div class="form-group col-md-4">
                  ...
                  value="{{ $authors->email }}" placeholder="Enter Firstname of author">
                </div>
                {{-- <div class="form-group col-md-4">
                ...
                <div class="form-group col-md-4">
                  ...
                  value="{{ $authors->user->mobile }}" placeholder="Enter Firstname of author">
                </div>
               </div>
...
<script>
   function performUpdate(id){
    ...
    storeRoute('/cms/author/authors_update/'+id , formData);
